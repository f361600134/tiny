							...
							<ul id="jquery-demo">
							  <li>
							    ...
							    <div data-scroll-reveal="enter bottom but wait 0.7s" class="slider-detils">
							    	<h3>Hello,  <label>My Followers! </label>Welcome To My Blog! </h3>
							    	<span>鉴于我英文不好,以下全部用中文表示!<i> 此博客暂时只有写博客功能,其实有很多话想跟My followers说,但碍于空间有限.我只想说:欢迎大家踊跃访问!</i></span>
							  ...
							  <li>
							    <a href="#slide2">
							      ...
							      <div data-scroll-reveal="enter bottom but wait 1s" class="slider-detils">	
							    	<h3>Hello,  <label>My Follower!  </label>Welcome To My Blog! </h3>
							    	<span>鉴于我英文不好,以下全部用中文表示!<i> 此博客暂时只有写博客功能,其实有很多话想跟My followers说,但碍于空间有限.我只想说:欢迎大家踊跃访问!</i></span>
							    	<a class="slide-btn" href="#">View Projects</a>
							    </div>
							  </li>
				...
				<!---//End-gallery-script----->
					       <div id="owl-demo" class="owl-carousel">
				                <div class="item" id="example1">
				                	<div data-scroll-reveal="enter bottom but wait 0.7s" class="grid-block fade">
							        	<div class="caption">
							        	...
							        	<img src="<%=path %>/images/body/w1.jpg" />
							        </div>
							        <div data-scroll-reveal="enter bottom but wait 0.7s" class="grid-block fade">
							        	<div class="caption">
							            	<h4>Beatiful Mountain</h4>
							        	...
							        	<img src="<%=path %>/images/body/w2.jpg" />
							        </div>
							        <div data-scroll-reveal="enter bottom but wait 0.7s" class="grid-block fade">
							        	<div class="caption">
							            	<h4>Beatiful Mountain</h4>
							        	...
							        	<img src="<%=path %>/images/body/w3.jpg" />
							        </div>
							        <div data-scroll-reveal="enter bottom but wait 0.7s" class="grid-block fade">
							        	<div class="caption">
							            	<h4>Beatiful Mountain</h4>
							        	...
							        	<img src="<%=path %>/images/body/w4.jpg" />
							        </div>
							        <div data-scroll-reveal="enter bottom but wait 0.7s" class="grid-block fade">
							        	<div class="caption">
							            	<h4>Beatiful Mountain</h4>
							        	...
							        	<img src="<%=path %>/images/body/w5.jpg" />
							        </div>
							        <div data-scroll-reveal="enter bottom but wait 0.7s" class="grid-block fade">
							        	<div class="caption">
							            	<h4>Beatiful Mountain</h4>
							        	...
							        	<img src="<%=path %>/images/body/w6.jpg" />
							        </div>
							        <div data-scroll-reveal="enter bottom but wait 0.7s" class="grid-block fade">
							        	<div class="caption">
							            	<h4>Beatiful Mountain</h4>
							        	...
							        	<img src="<%=path %>/images/body/w7.jpg" />
							        </div>
							        <div data-scroll-reveal="enter bottom but wait 0.7s" class="grid-block fade">
							        	<div class="caption">
							            	<h4>Beatiful Mountain</h4>
							        	...
							        	<img src="<%=path %>/images/body/w8.jpg" />
							        </div>
				                </div>
					...
					<div class="blog" id="blog">
						<div class="wrap">
							...
							<div class="blog-artical-grids">
								<div data-scroll-reveal="enter bottom but wait 0.7s" class="artical-grid">
									<div class="artical-grid-head">
										<img class="post-pic" src="<%=path %>/images/body/artical-pic1.jpg">
										<span class="admin1"><img src="<%=path %>/images/body/admin1.jpg" title="admin-name" /></span>
									</div>
									<div class="artical-info">
										<label class="poston">2014-04-12</label>
										<p>这是一个小二逼.经常这样子喊他.</p>
									</div>
								</div>
								<div data-scroll-reveal="enter bottom but wait 0.7s" class="artical-grid">
									<div class="artical-grid-head">
									    <a href="blog.html">
										<img class="post-pic" src="<%=path %>/images/body/artical-pic2.jpg">
										<span class="admin1"><img src="<%=path %>/images/body/admin2.jpg" title="admin-name" /></span>
										</a>
									</div>
									<div class="artical-info">
										<label class="poston">2014-04-12</label>
										<p>没有照片了,拿这个小逗比拿来充数</p>
									</div>
								</div>
								<div data-scroll-reveal="enter bottom but wait 0.7s" class="artical-grid">
									<div class="artical-grid-head">
										<img class="post-pic" src="<%=path %>/images/body/artical-pic3.jpg">
										<span class="admin1"><img src="<%=path %>/images/body/admin3.jpg" title="admin-name" /></span>
									</div>
									<div class="artical-info">
										<label class="poston">2014-04-12</label>
										<p>我是实在没办法了!!</p>
